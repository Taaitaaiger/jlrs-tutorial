...
Many operations are delegated to this library, these operation tend to be very cheap compared to the overhead of calling a function. Because the library is written in C, these functions will never be inlined.
...
CC=clang-18 \
cargo build --release --features jlrs/lto
```
